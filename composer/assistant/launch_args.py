...
class LaunchNatSpecArgs(BaseModel):
    ...
    prover_conf: dict | None = Field(
        ...
        description=(
            ...
            "into every typecheck invocation. Dynamic keys (`files`, `verify`, `solc`) are "
            "always set by the pipeline and override whatever is in this object. Pass inline "
            "as a dict; null means no overrides."
        ),
    )
